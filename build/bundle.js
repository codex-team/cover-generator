...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        key: 'setTextColor',
        value: function setTextColor(element, color) {
        ...
        key: 'setTextFontSize',
        value: function setTextFontSize(element, size) {
        ...
        key: 'setElementAlignment',
        value: function setElementAlignment(element, horisontal) {

            var align = {
                horisontal: this.alignment.horisontal
            };

            for (var key in this.CSS.alignment) {
        ...
        value: function createText(type) {
            ...
            var text = $.make('div', [this.CSS.element, this.CSS.elements[type]]);
        ...
        key: 'insertAtCaret',
        value: function insertAtCaret(text) {
        ...
        key: 'createImage',
        value: function createImage(link) {

            var image = $.make('img', [this.CSS.element, this.CSS.elements.image], { src: 'src/assets/icon-picture.svg' });
